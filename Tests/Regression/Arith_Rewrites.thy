theory Arith_Rewrites
  imports "HOL.Dsl_Nary_Ops" Arith_Rewrites_Lemmas
begin
...
lemma [rewrite_arith_plus_zero]:
  ...
  subgoal for ss ts 
    ...
    by (simp_all only: arith_plus_zero_lemma)
  done
...
lemma [rewrite_arith_mul_one]:
  ...
  subgoal for ss ts 
    apply (simp only: cvc_list_left_transfer cvc_list_right_transfer_op cvc_list_both_transfer_op)
    by (simp_all only: arith_mul_one_lemma)
  done
...
lemma [rewrite_arith_mul_zero]:
  ...
  subgoal for ss ts 
    apply (simp only: cvc_list_left_transfer cvc_list_right_transfer_op cvc_list_both_transfer_op)
    by (simp_all only: arith_mul_zero_lemma)
  done
...
lemma [rewrite_arith_plus_flatten]:
  ...
  subgoal for zss yss xss 
    apply (simp only: cvc_list_left_transfer cvc_list_right_transfer_op cvc_list_both_transfer_op)
    by (simp_all only: arith_plus_flatten_lemma)
  done
...
lemma [rewrite_arith_mult_flatten]:
  ...
  subgoal for zss yss xss 
    apply (simp only: cvc_list_left_transfer cvc_list_right_transfer_op cvc_list_both_transfer_op)
    by (simp_all only: arith_mult_flatten_lemma)
  done
...
lemma [rewrite_arith_mult_dist]:
  ...
  subgoal for ws 
    apply (simp only: cvc_list_left_transfer cvc_list_right_transfer_op cvc_list_both_transfer_op)
    by (simp_all only: arith_mult_dist_lemma)
  done
...
lemma [rewrite_arith_plus_cancel2]:
  ...
  subgoal for rs ss ts 
    apply (simp only: cvc_list_left_transfer cvc_list_right_transfer_op cvc_list_both_transfer_op)
    by (simp_all only: arith_plus_cancel2_lemma)
  done
